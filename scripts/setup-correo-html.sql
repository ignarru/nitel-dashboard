...
ALTER TABLE leads_nitel ADD COLUMN IF NOT EXISTS correo_1_html TEXT;
ALTER TABLE leads_nitel ADD COLUMN IF NOT EXISTS correo_2_html TEXT;
ALTER TABLE leads_nitel ADD COLUMN IF NOT EXISTS correo_3_html TEXT;
